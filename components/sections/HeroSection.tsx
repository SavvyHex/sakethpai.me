  ...
  return (
    ...
    >
      ...
      <div className="px-4 py-2 sm:px-5 bg-[#084c61] border-2 border-[#177e89] rounded-lg inline-block">
        ...
        <div className="text-base sm:text-lg font-bold text-foreground">{personalInfo.title}</div>
      </div>
      <p className="text-sm sm:text-base text-foreground/70 mx-auto">{personalInfo.location}</p>
    </motion.div>
  );
}
